...
def main():
    ...
    for degree in degrees:
        ...
        single_train_mse = mse(y_train, y_single_train_pred)
        single_test_mse = mse(y_test, y_single_test_pred)
        ...
        multi_train_mse = mse(y_train, y_multi_train_pred)
        multi_test_mse = mse(y_test, y_multi_test_pred)
